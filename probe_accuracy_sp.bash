...
python src/inference_main_sp.py --model ${PROBE_RUN_MODEL} --weight_file ${PROBE_RUN}_model_state.pt --out /tmp/${PROBE_RUN}_emb.txt --best_matches ${PROBE_RUN}_matches.txt || exit 1
